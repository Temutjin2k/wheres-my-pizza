...
import (
	httpserver "github.com/Temutjin2k/wheres-my-pizza/tracking-service/internal/adapter/http/server"
	postgresRepo "github.com/Temutjin2k/wheres-my-pizza/tracking-service/internal/adapter/postgres"
...
func (app *App) Run() error {
	...
	case errRun := <-errCh:
		return errRun
	case s := <-shutdownCh:
		app.log.Info(ctx, "app_shutdown", "shuting down application", "signal", s.String())
